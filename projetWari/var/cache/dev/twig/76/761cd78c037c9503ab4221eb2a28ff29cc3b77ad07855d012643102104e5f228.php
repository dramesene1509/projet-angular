...
class __TwigTemplate_970272433a19663fa42ca0b0e855ae2a08864d4223f4476efa05bd53f5d4c206 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<label<?php if (\$label_attr) { echo ' '.\$view['form']->block(\$form, 'attributes', ['attr' => \$label_attr]); } ?>><?php echo \$view->escape(false !== \$translation_domain ? \$view['translator']->trans(\$label, \$label_translation_parameters, \$translation_domain) : \$label) ?></label>
<?php endif ?>
", "@Framework/Form/form_label.html.php", "/home/aminata/projetWari/vendor/symfony/framework-bundle/Resources/views/Form/form_label.html.php");
    }
}

...
// Returns the private 'App\DataFixtures\AuthenFixtures' shared autowired service.
...
include_once $this->targetDirs[3].'/src/DataFixtures/AuthenFixtures.php';

return $this->privates['App\\DataFixtures\\AuthenFixtures'] = new \App\DataFixtures\AuthenFixtures(($this->services['security.password_encoder'] ?? $this->load('getSecurity_PasswordEncoderService.php')));
